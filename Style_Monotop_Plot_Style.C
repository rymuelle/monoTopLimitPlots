...
// By ROOT version 5.34/36 on 2016-09-11 19:30:53
...
void Style_Monotop_Plot_Style()
{
   // Add the saved style to the current ROOT session.

   delete gROOT->GetStyle("Monotop_Plot_Style");

   TStyle *tmpStyle = new TStyle("Monotop_Plot_Style", "Imported from canvas name");
   ...
   tmpStyle->SetLabelOffset(0.007, "x");
   tmpStyle->SetLabelOffset(0.007, "y");
   tmpStyle->SetLabelOffset(0.007, "z");
   ...
   tmpStyle->SetTitleOffset(1.25, "y");
   ...
   tmpStyle->SetCanvasDefX(0);
   tmpStyle->SetCanvasDefY(0);
